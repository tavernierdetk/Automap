    ...
    return {
        ...
        "environment": {
            ...
            "hazards": [{"id": "%s-crack" % lid, "name": "Ground Crack",
                         "trigger": "quake", "sprite": "crack_0",
                         "payload": {"amount": 20 + 4 * k}}],
            "shifts": [{"at": 5, "name": "the ground gives way",
                        "add_hazard": {"id": "%s-puddle" % lid, "name": "Seeping Puddle",
                                       "trigger": "quake", "sprite": "puddle_0",
                                       "payload": {"amount": 18 + 3 * k}}}],
        },
        "encounters": enc,
